#Tabla personas
ALTER TABLE personas ADD FOREIGN KEY(id_posicion) REFERENCES posicion_jugador (id_posicion);

#Tabla personas
ALTER TABLE personas ADD FOREIGN KEY(id_equipo) REFERENCES equipos (id_equipo);

#Tabla personas
ALTER TABLE personas ADD FOREIGN KEY(id_rol) REFERENCES roles (id_rol);

#Tabla equipos
ALTER TABLE equipos ADD FOREIGN KEY(id_director_tec) REFERENCES personas (id_persona);

#Tabla tarjetas
ALTER TABLE tarjetas ADD FOREIGN KEY(id_persona) REFERENCES personas (id_persona);

ALTER TABLE tarjetas ADD FOREIGN KEY(id_sancion) REFERENCES sancion(id_sancion);

ALTER TABLE historial_tarjetas ADD FOREIGN KEY(id_persona) REFERENCES personas (id_persona);
...
ALTER TABLE estadistica_jugador ADD FOREIGN KEY(id_persona) REFERENCES personas (id_persona);
...
ALTER TABLE asistencias_jugador ADD FOREIGN KEY(id_persona) REFERENCES personas (id_persona);
